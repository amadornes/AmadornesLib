package es.amadornes.lib.color;
...
public class ColorUtil
{
  ...
  public static Color blend(Color[] colors, float[] percentages){
	  float[] per = percentages;
	  ...
	  if(totalPercentage != 100){
		  ...
		  for(int i = 0; i < percentages.length; i++){
			  per[i] = percentages[i] * diff;
		  }
	  }
	  
	  //Makes the total percentage 100% always
