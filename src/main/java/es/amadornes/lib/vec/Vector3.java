...
public class Vector3 {
    ...
    public boolean isBlock(Block b, boolean checkAir) {
        ...
        if (hasWorld()) {
            ...
            if (b == null
                    && checkAir
                    && Block.blocksList[w.getBlockId((int) x, (int) y, (int) z)].blockMaterial == Material.air) return true;
            if (b == null
                    && checkAir
                    && Block.blocksList[w.getBlockId((int) x, (int) y, (int) z)]
                            .isAirBlock(w, (int) x, (int) y, (int) z)) return true;
            
            return Block.blocksList[w.getBlockId((int) x, (int) y, (int) z)]
                    .getClass().isInstance(b);
        }
        return false;
    }
    ...
    public static Vector3 fromString(String s) {
        ...
        if (s.startsWith("Vector3{") && s.endsWith("}")) {
            ...
            while (st.hasMoreTokens()) {
                ...
                if (t.toLowerCase().startsWith("x")) x = Double.parseDouble(t
                        .split("=")[1]);
                if (t.toLowerCase().startsWith("y")) y = Double.parseDouble(t
                        .split("=")[1]);
                if (t.toLowerCase().startsWith("z")) z = Double.parseDouble(t
                        .split("=")[1]);
            }
