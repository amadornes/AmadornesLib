...
public class RenderHelper {
    ...
    public static void drawTexturedCube(Vector3fMax vector) {
        ...
        RenderHelper.vertexWithTexture(vector.getXMax(), vector.getYMax(), vector.getZMin(), 1.0F, 1.0F);
        ...
        RenderHelper.vertexWithTexture(vector.getXMin(), vector.getYMin(), vector.getZMax(), 1.0F, 0.0F);
        RenderHelper.vertexWithTexture(vector.getXMin(), vector.getYMax(), vector.getZMax(), 1.0F, 1.0F);
        RenderHelper.vertexWithTexture(vector.getXMin(), vector.getYMax(), vector.getZMin(), 0.0F, 1.0F);
        ...
        RenderHelper.vertexWithTexture(vector.getXMin(), vector.getYMax(), vector.getZMin(), 1.0F, 1.0F);
        ...
        RenderHelper.vertexWithTexture(vector.getXMax(), vector.getYMax(), vector.getZMax(), 1.0F, 1.0F);
    ...
    public static final void drawColoredRect(double x, double y, double width, double height, Color color) {
