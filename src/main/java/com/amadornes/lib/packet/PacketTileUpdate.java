...
public class PacketTileUpdate extends AmaPacket<PacketTileUpdate> {
    ...
    public void read(NBTTagCompound tag) {
        ...
        if (Minecraft.getMinecraft().theWorld.provider.dimensionId != dim) return;
        ...
        parent = (TileEntityTile) w.getTileEntity(x, y, z);
        tile = parent.getContainedTile();
    ...
    public void handle(Side side) {
        ...
        if (side.isClient()) tile.readDescription(tag);
    }
