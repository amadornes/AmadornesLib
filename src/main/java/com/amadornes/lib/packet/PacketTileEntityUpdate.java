...
public class PacketTileEntityUpdate extends AmaPacket<PacketTileEntityUpdate> {
    
    private AmaTileEntity  te;
    private NBTTagCompound tag;
    
    public PacketTileEntityUpdate(AmaTileEntity te) {
    ...
    public void read(NBTTagCompound tag) {
        ...
        te = (AmaTileEntity) w.getTileEntity(x, y, z);
